...
for fashion_images in os.listdir('C:/Users/Mukta/PycharmProjects/fashion_recom_system/images'):
    images_path = os.path.join('C:/Users/Mukta/PycharmProjects/fashion_recom_system/images', fashion_images)
